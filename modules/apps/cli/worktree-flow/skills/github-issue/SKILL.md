...
comment`, run the body through the [`humanizer`](../humanizer/SKILL.md) skill
...
commit message) isn't authored by this skill and isn't run through humanizer.
...
5. Comment on the PR summarizing what was addressed. Run the comment body
   through the [`humanizer`](../humanizer/SKILL.md) skill before calling
...
Run the comment body through the [`humanizer`](../humanizer/SKILL.md) skill
