...
Defines the file structure and import patterns for decomposing the Claude Code NixOS/Home Manager module into focused configuration fragments under `cfg/`.
