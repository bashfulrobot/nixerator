...

{
  ...
  apps.cli = {
    ...
    # Q4_K_M fits VRAM with headroom (bump to Q6_K for more quality). loadModels
    # and defaultGooseModel both read globals.ai.localCodeModel, so the pulled
    # model and the model goose requests cannot drift. The module exports
    ...
    ollama = {
      ...
      # truncates long goose sessions well before Mellum2's real limit.
